...
import (
	...
	"github.com/thisiskazem/liqo-upgrade-controller/internal/controller"
...
func init() {
	...
	// Add apiextensions scheme to support CRD operations (listing, etc.)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4fc33488.liqo.io",
	...
	if err := (&controller.LiqoUpgradeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LiqoUpgrade")
		os.Exit(1)
	}
