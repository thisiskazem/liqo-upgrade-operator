...
KIND_CLUSTER ?= liqo-upgrade-controller-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name liqo-upgrade-controller-builder
	$(CONTAINER_TOOL) buildx use liqo-upgrade-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm liqo-upgrade-controller-builder
	rm Dockerfile.cross
